...
raw <- 
  bind_rows(
    read_excel(file.path("data", "20170721__data_export.xlsx")) 
  ) %>% 
...
# look at single run
### CHANGE ###
raw  %>% filter(File =="1340__170720_A5_PTV_50%more concentrated_A5dilutionsTest_CO2_newVial_14ng@ul.dxf")  %>% View()
```
...
data_matched <- map_peaks(raw, metadata_file = file.path("metadata", "smoky_hollow_peaks_July21.xlsx"), quiet = FALSE)
```
