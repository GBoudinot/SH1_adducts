...
raw <- 
  bind_rows(
    read_excel(file.path("data", "20170809__data_export.xlsx")) 
  ) %>% 
...
# look at single run
### CHANGE ###
raw  %>% filter(File =="1538__170805_A5_PTV_1_0_A5dilutionsTest_CO2_newVial_14ng@ul.dxf")  %>% View()
```
...
data_matched <- map_peaks(raw, metadata_file = file.path("metadata", "smoky_hollow_peaks_August05.xlsx"), quiet = FALSE)
```
