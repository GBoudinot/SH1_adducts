---
title: "20171207_C_standards_and_samples_GB"
author: "GB"
date: "12/7/2017"
...
```{r}
metadata_samples <- read_excel(file.path("metadata", "20171207_GB_metadata.xlsx"), sheet = "files")
metadata_peak_maps <- read_excel(file.path("metadata","20171207_GB_metadata.xlsx"), sheet = "maps")
