...
raw <- 
  bind_rows(
    read_excel(file.path("data", "20170803__data_export.xlsx")) 
  ) %>% 
...
# look at single run
### CHANGE ###
raw  %>% filter(File =="1477__170731_A5_PTV_0_5_A5dilutionsTest_CO2_newVial_7ng@ul.dxf")  %>% View()
```
...
data_matched <- map_peaks(raw, metadata_file = file.path("metadata", "smoky_hollow_peaks_August03.xlsx"), quiet = FALSE)
```
