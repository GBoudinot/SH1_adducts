...
raw <- 
  bind_rows(
    read_excel(file.path("data", "20180206_Ctest.xlsx")) 
  ) %>% 
...
data_matched <- map_peaks(raw, metadata_file = file.path("metadata", "20180206m_Ctest.xlsx"), quiet = FALSE)
```
