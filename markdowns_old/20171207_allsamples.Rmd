...
raw <- 
  bind_rows(
    read_excel(file.path("data", "20171207__data_export.xlsx")) 
  ) %>% 
...
# look at single run
### CHANGE ###
raw  %>% filter(File =="BF2910__A5_1_5uL_.dxf")  %>% View()
```
...
data_matched <- map_peaks(raw, metadata_file = file.path("metadata", "20171207_GB_metadata.xlsx"), quiet = FALSE)
```
