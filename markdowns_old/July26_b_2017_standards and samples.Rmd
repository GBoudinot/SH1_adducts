...
raw <- 
  bind_rows(
    read_excel(file.path("data", "20170726_c_data_export.xlsx")) 
  ) %>% 
...
data_matched <- map_peaks(raw, metadata_file = file.path("metadata", "smoky_hollow_peaks_July26_b.xlsx"), quiet = FALSE)
```
