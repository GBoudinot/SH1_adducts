...
raw <- 
  bind_rows(
    read_excel(file.path("data", "20170728__data_export (1).xlsx")) 
  ) %>% 
...
# look at single run
### CHANGE ###
raw  %>% filter(File =="1440__170727_PTV_2uL_OG051 .dxf")  %>% View()
```
...
data_matched <- map_peaks(raw, metadata_file = file.path("metadata", "smoky_hollow_peaks_July28.xlsx"), quiet = FALSE)
```
