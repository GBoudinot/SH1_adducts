...
raw <- 
  bind_rows(
    read_excel(file.path("data", "20180202_A6 test.xlsx")) 
  ) %>% 
...
data_matched <- map_peaks(raw, metadata_file = file.path("metadata", "20180202_Ctest .xlsx"), quiet = FALSE)
```
